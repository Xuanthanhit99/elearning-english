...
export const ACHIEVEMENT_CATALOG: AchievementSeedDefinition[] = [
  ...
  {
    code: 'club_challenge_first',
    title: 'Thu thach dau tien',
    description: 'Hoan thanh thu thach cong dong dau tien.',
    icon: 'trophy',
  ...
  {
    code: 'study_room_first',
    title: 'Buoi hoc nhom dau tien',
    description: 'Hoan thanh buoi hoc nhom dau tien trong phong hoc.',
    icon: 'users',
    category: AchievementCategory.COMMUNITY,
    rarity: AchievementRarity.COMMON,
    visibility: AchievementVisibility.PUBLIC,
    ruleType: AchievementRuleType.TOTAL_COUNT,
    eventType: 'STUDY_ROOM_SESSION_COMPLETED',
    targetValue: 1,
    rewardXp: 20,
    rewardCoins: 5,
    displayOrder: 200,
  ...
  {
    code: 'study_room_10',
    title: 'Nguoi hoc nhom ben bi',
    description: 'Hoan thanh 10 buoi hoc nhom.',
    icon: 'users',
    category: AchievementCategory.COMMUNITY,
    rarity: AchievementRarity.UNCOMMON,
    visibility: AchievementVisibility.PUBLIC,

...
const vi: VocabContent = {
  ...
  completedModal: {
    ...
    tipDesc: "Học quá nhiều từ mới trong một ngày có thể làm giảm khả năng ghi nhớ. PoppyLingo khuyến nghị 10-20 từ/ngày và ưu tiên ôn tập SRS.",
...
const en: VocabContent = {
  ...
  completedModal: {
    ...
    tipDesc: "Learning too many new words in one day can hurt retention. PoppyLingo recommends 10-20 words/day and prioritizing SRS review.",
...
const zh: VocabContent = {
  ...
  completedModal: {
    ...
    minutes: "{n} 分钟",
    tipTitle: "可持续学习建议",
    tipDesc: "一天学习太多新单词可能会降低记忆效果。PoppyLingo 建议每天学习 10-20 个单词，并优先进行 SRS 复习。",
...
const de: VocabContent = {
  ...
  completedModal: {
    ...
    tipDesc: "Zu viele neue Wörter an einem Tag können das Behalten verschlechtern. PoppyLingo empfiehlt 10-20 Wörter/Tag und Vorrang für SRS-Wiederholung.",

...
const reviewWords = [
  ["adventure", "/É™dËˆventʃər/", "Khó", "red"],
  ["memorable", "/Ëˆmemərəbl/", "Trung bình", "orange"],
  ["explore", "/ÉªkËˆsplɔːr/", "Dễ", "green"],
  ["experience", "/ÉªkËˆspɪəriəns/", "Trung bình", "orange"],
  ["destination", "/ËŒdestÉªËˆneɪʃn/", "Dễ", "green"],
];
                  ...
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-purple-500">
                        ?ánh giá chính xác mức độ nhớ của bạn. Hệ thống sẽ sắp xếp
                        lịch ôn tập phù hợp.
                      </p>
                    </div>
                  </div>
            ...
            <aside className="space-y-6">
              <Card>
                ...
                <div className="grid grid-cols-3 text-center">
                  ...
                  <Mini value="17" label="?ã ôn xong" icon="✅" />

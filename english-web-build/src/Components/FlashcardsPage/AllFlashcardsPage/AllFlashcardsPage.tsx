            ...
            <section>
              ...
              <div className="mb-7 flex items-center justify-between border-b border-purple-100 pb-7">
                <div className="flex gap-4">
                  {["Tất cả", "Mới học", "Đang ôn", "Khó", "?ã thuộc", "Yêu thích"].map(
                    (item, i) => (
                      <button
                        key={item}
    ...
    <aside className="space-y-6">
      <Card>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Overview icon="✅" value="28" label="?ã thuộc" />
      ...
      <Card className="flex items-center justify-between">
        <div>
          <h3 className="mb-3 text-xl font-black">Gợi ý từ Beacon</h3>

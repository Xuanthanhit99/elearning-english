...
const testimonials = [
  ...
  },
  {
    name: "Hà My",
    avatar: "M",
    text: "BeaconVie tạo cảm giác học nhẹ nhàng hơn, không bị áp lực như trước.",
  },
];
      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <h2 className="text-4xl font-extrabold text-[#1f2a44] sm:text-5xl">
            Người học nói gì về BeaconVie?
          </h2>

          <p className="mt-5 text-lg leading-8 text-[#5b6b85]">
            ?ánh giá giúp trang chủ đáng tin hơn và phù hợp với mọi nhóm người dùng.
          </p>
        </div>

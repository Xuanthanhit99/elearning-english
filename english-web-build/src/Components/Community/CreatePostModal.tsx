...
const options: Array<{ type: CommunityPostType; label: string; description: string; icon: typeof BookOpen }> = [
  ...
  { type: 'SPEAKING', label: 'Chia sẻ bài nói', description: '?ăng audio để mọi người lắng nghe', icon: Mic },
  { type: 'WRITING', label: 'Chia sẻ bài viết', description: '?ăng đoạn văn hoặc bài luận', icon: PenLine },
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4">
      <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-3xl bg-white shadow-2xl">
        <div className="flex items-center justify-between border-b px-6 py-5">
          ...
          <button type="button" onClick={onClose} aria-label="?óng" className="rounded-full p-2 hover:bg-slate-100"><X aria-hidden /></button>
        </div>
